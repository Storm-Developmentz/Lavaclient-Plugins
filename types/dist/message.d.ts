import type { OpCode, PlayerOpCode } from "./protocol";
import type { EqualizerBand, PlayerUpdate, TrackEndEvent, TrackExceptionEvent, TrackStartEvent, TrackStuckEvent, WebSocketClosedEvent } from "./player";
